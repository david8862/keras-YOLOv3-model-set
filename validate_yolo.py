...
from predict import predict, get_classes, get_colors, draw_boxes# preprocess_image, get_classes, get_colors, yolo_head, handle_predictions, adjust_boxes
from tensorflow.keras.models import load_model


def validate_yolo_model(model, image_file, class_names, model_image_size):
    ...
    #interpreter.invoke()
    boxes, classes, scores = predict(model, image, len(class_names), model_image_size)
...
def main():
    ...
    validate_yolo_model(model, args.image_file, class_names, model_image_size)
