...
from scaled_yolo4.models.layers import scaled_yolo4_csp_predictions
...
def scaled_yolo4_csp_body(inputs, num_anchors, num_classes, weights_path=None):
    ...
    y1, y2, y3 = scaled_yolo4_csp_predictions((f1, f2, f3), (f1_channel_num, f2_channel_num, f3_channel_num), num_anchors, num_classes)
