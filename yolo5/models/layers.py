...
def tiny_yolo5_predictions(feature_maps, feature_channel_nums, num_anchors, num_classes, use_spp):
    f1, f2 = feature_maps
...
def tiny_yolo5lite_predictions(feature_maps, feature_channel_nums, num_anchors, num_classes, use_spp):
    f1, f2 = feature_maps
    f1_channel_num, f2_channel_num = feature_channel_nums
