...
# -*- coding: utf-8 -*-
#
# A tf.keras implementation of mobilenet,
# which is ported from https://github.com/keras-team/keras-applications/blob/master/keras_applications/mobilenet.py
#
#
