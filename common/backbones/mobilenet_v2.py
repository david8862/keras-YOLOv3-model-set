...
# -*- coding: utf-8 -*-
#
# A tf.keras implementation of mobilenet_v2,
# which is ported from https://github.com/keras-team/keras-applications/blob/master/keras_applications/mobilenet_v2.py
#
#
