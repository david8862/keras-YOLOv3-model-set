...
def ghostnet(**kwargs):
    ...
    if pretrained:
        ...
        weights_url = 'https://github.com/huawei-noah/CV-Backbones/blob/master/ghostnet_pytorch/models/state_dict_73.98.pth?raw=true'
...
if __name__=='__main__':
    ...
    preds = softmax(model(image_data).detach().cpu().numpy())
